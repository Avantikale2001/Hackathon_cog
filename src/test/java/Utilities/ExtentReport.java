...
public class ExtentReport implements ITestListener {
	...
	public void onStart(ITestContext testContext) 
	{
		...
		sparkReporter.config().setDocumentTitle("COURSERA View Report"); 
		sparkReporter.config().setReportName("COURSERA Functional Testing"); 
		...
		extent.setSystemInfo("User Name", "Avanti Kale");
